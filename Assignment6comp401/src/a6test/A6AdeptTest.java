...
public class A6AdeptTest {
	...
	public void testTileBasic() {
		...
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_1a),
				subpic_1.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_1b),
				subpic_1.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_1c),
				subpic_1.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_1d),
				subpic_1.getPixel(sp_d));
		// SubPic2: (2, 0) to (3, 1)
		assertTrue(s1_tileiterator.hasNext());
		Picture subpic_2 = s1_tileiterator.next();
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_2a),
				subpic_2.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_2b),
				subpic_2.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_2c),
				subpic_2.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_1.getPixel(s_2d),
				subpic_2.getPixel(sp_d));
	...
	public void testTileFitted() {
		...
		assertTrue(s1_tileiterator.hasNext());
		Picture subpic_1 = s1_tileiterator.next();
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_1a),
				subpic_1.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_1b),
				subpic_1.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_1c),
				subpic_1.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_1d),
				subpic_1.getPixel(sp_d));
		// SubPic2: (2, 0) to (3, 2)
		assertTrue(s1_tileiterator.hasNext());
		Picture subpic_2 = s1_tileiterator.next();
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_2a),
				subpic_2.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_2b),
				subpic_2.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_2c),
				subpic_2.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_2d),
				subpic_2.getPixel(sp_d));
		// SubPic3: (0, 3) to (1, 5)
		assertTrue(s1_tileiterator.hasNext());
		Picture subpic_3 = s1_tileiterator.next();
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_3a),
				subpic_3.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_3b),
				subpic_3.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_3c),
				subpic_3.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_3d),
				subpic_3.getPixel(sp_d));
		// SubPic4: (2, 3) to (3, 5)
		assertTrue(s1_tileiterator.hasNext());
		Picture subpic_4 = s1_tileiterator.next();
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_4a),
				subpic_4.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_4b),
				subpic_4.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_4c),
				subpic_4.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_4d),
				subpic_4.getPixel(sp_d));
		assertFalse(s1_tileiterator.hasNext());
	}
	...
	public void testTileFullSize() {
		...
		assertTrue(s1_tileiterator.hasNext());
		Picture subpic_1 = s1_tileiterator.next();
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_a),
				subpic_1.getPixel(sp_a));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_b),
				subpic_1.getPixel(sp_b));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_c),
				subpic_1.getPixel(sp_c));
		assertEquals("The next pixel retrieved by the tile iterator is not the expected pixel", source_2.getPixel(s_d),
				subpic_1.getPixel(sp_d));
		assertFalse(s1_tileiterator.hasNext());
	}
